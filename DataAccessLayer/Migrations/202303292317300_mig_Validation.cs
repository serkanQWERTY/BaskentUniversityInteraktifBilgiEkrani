namespace DataAccessLayer.Migrations
{
    ...
    public partial class mig_Validation : DbMigration
    {
        ...
        {
            AlterColumn("dbo.Roles", "RoleDescription", c => c.String(maxLength: 1000));
            AlterColumn("dbo.Roles", "RoleShortName", c => c.String(maxLength: 3));
            AlterColumn("dbo.Roles", "RoleName", c => c.String(maxLength: 50));
            AlterColumn("dbo.Tvs", "TvAddress", c => c.String(maxLength: 1000));
            AlterColumn("dbo.Tvs", "TvDescription", c => c.String(maxLength: 1000));
            AlterColumn("dbo.News", "NewDescription", c => c.String(maxLength: 1000));
            AlterColumn("dbo.News", "NewPath", c => c.String(maxLength: 1000));
            AlterColumn("dbo.News", "NewName", c => c.String(maxLength: 100));
            AlterColumn("dbo.Users", "UserMail", c => c.String(maxLength: 50));
            ...
            AlterColumn("dbo.Faculties", "FacultyAddress", c => c.String(maxLength: 1000));
            AlterColumn("dbo.Faculties", "FacultyName", c => c.String(maxLength: 100));
            AlterColumn("dbo.Departments", "DepartmentAddress", c => c.String(maxLength: 1000));
